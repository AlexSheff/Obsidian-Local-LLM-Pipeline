...
start "Hermes Llama Server" cmd /k "C:\Users\admin_fdr\.llama_setup\cpu\llama-server.exe -m E:\AI_text\lm_studio\NousResearch\Hermes-3-Llama-3.2-3B-GGUF\Hermes-3-Llama-3.2-3B.Q4_K_M.gguf -c 2048 -ngl -1"
